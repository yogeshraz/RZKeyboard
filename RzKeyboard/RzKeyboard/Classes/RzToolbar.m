...
@interface RzToolbar () <UITextFieldDelegate>
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        _barButtonItemPrevious = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Previous", nil) style:UIBarButtonItemStyleDone target:self action:@selector(barButtonItemPreviousTouchUpInside:)] ;
        _barButtonItemNext = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Next", nil) style:UIBarButtonItemStyleDone target:self action:@selector(barButtonItemNextTouchUpInside:)];
...
+ (RzToolbar *)defaultToolbar {
    ...
    RzToolbar *toolbar = [[RzToolbar alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 320.0f, 44.0f)];
